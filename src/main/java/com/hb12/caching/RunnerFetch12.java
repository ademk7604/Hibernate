...
//		Student12 student1= session.get(Student12.class,1L);
		...
		//clear metodu ile cache temizlendi. icin 2 arama gerceklesti
		//session.clear(); // 
		
//		System.out.println("Second get for id 1"); yukardaki ile ayni arama oldugu icin bir daha DB ye gitmedi ve gostermedi
...
//		Student12 student2= session.get(Student12.class,2L);
		...
		String hqlQuery1="FROM Student12 s where s.id=1"; // cacheble icin buradan deva,
		...
		System.out.println(student2); //bir adey sorgu geldi
		// cueryschace her yerde kullanma. cok sorgu yaptigin yerde kullanabilirsin.
		...
		System.out.println("First get for id 1");
		Student12 student2= session2.get(Student12.class,1L); //burda farkli iki sessin oldugu icin bir daha araam yapiyor
