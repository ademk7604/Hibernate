...
public class RunnerFetch01 {
	public static void main(String[] args) {
		...
		// SessionFactory interface si ile fabrika olusturuyoruz. fabrika ile sessionlar olusturacagiz.
...
//		System.out.println(student3);
		...
		// SQL Örneği
//		String sqlQuery1="SELECT * FROM t_student01"; // (tablo adini boyle vermistim)
//		List<Object[]> resultList1= session.createSQLQuery(sqlQuery1).getResultList(); // sadece boyle de yazdirilir alttakisekilde de for a gidilebilir// sanki ic ice arry varmis gibi
//		 Query query1 = session.createQuery(sqlQuery1);
//		 List<Object[]> resultList2= session.createSQLQuery(sqlQuery2)// bu hata verecektir araya SQL girmesi lazim
//		for (Object[] objects : resultList2) {
//			System.out.println(Arrays.toString(objects));
//		}
		
		// HQL örneği---Sql sorgusunda FROM'dan sonra sınıf ismi kullanılmalı
		// kullanılmazsa student01 is not mapped alınır. (buyuk kucuk harf e duyarli)
...
//		}
		...
		// Dönecek kaydın unique bir kayıt olduğuna eminseniz uniqueResult() metodu kullanılabilir.
...
//		 System.out.println(uniqueResult1[0]+":"+uniqueResult1[1]+":"+uniqueResult1[2]);
		...
		String hqlQuery3="FROM Student01 std where std.name='John Coffee'";
		Student01 uniqueResult3= session.createQuery(hqlQuery2,Student01.class).uniqueResult();
