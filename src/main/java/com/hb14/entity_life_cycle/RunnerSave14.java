...
public class RunnerSave14 {
	...
	public static void main(String[] args) {
		...
		session.evict(student1); // yukardaki kaydedilmemis verileri evict ettigimde yukaridaki commit etmiyor
		session.merge(student1); // evict etrtigim yukardaki verileri kayit edilebilir diyorum
